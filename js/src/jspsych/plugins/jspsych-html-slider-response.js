...
jsPsych.plugins['html-slider-response'] = (function() {
  ...
  plugin.trial = function(display_element, trial) {
    ...
    // Sean Devine (11-21-2020): Moved stimulus to end so slider shows up on top rather than on bottom -- usually it is put in right after the parent div is defined
    //
